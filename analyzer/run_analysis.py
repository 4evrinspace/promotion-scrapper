"""
[Примечание] Данный скрипт предназначен для локальной отладки на CSV-файлах.
Боевой путь запуска сервиса — analyzer/run_service.py (автоматически через Docker Compose).
"""
